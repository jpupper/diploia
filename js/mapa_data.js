...
function getMapConnections() {
    return [
        ...
        { data: { id: 'docker-github', source: 'docker', target: 'github', type: 'secondary' } },
        { data: { id: 'blender-python', source: 'blender', target: 'python', type: 'secondary' } },
        { data: { id: 'unity-ar', source: 'unity', target: 'ar', type: 'secondary' } },
        { data: { id: 'unity-vr', source: 'unity', target: 'vr', type: 'secondary' } },
        { data: { id: 'python-raspberry-pi', source: 'python', target: 'raspberry-pi', type: 'secondary' } },
        { data: { id: 'javascript-sitio-web', source: 'javascript', target: 'sitio-web', type: 'secondary' } },
        ...
        // Conexiones adicionales entre nodos y categorías principales
        { data: { id: 'processing-languages', source: 'processing', target: 'languages', type: 'secondary' } },
        { data: { id: 'p5-software-multimedia', source: 'p5', target: 'software-multimedia', type: 'secondary' } },
        { data: { id: 'three-engines', source: 'three', target: 'engines', type: 'secondary' } },
        { data: { id: 'babylon-engines', source: 'babylon', target: 'engines', type: 'secondary' } },
        ...
        { data: { id: 'livecoding-software-multimedia', source: 'livecoding', target: 'software-multimedia', type: 'secondary' } },
        { data: { id: 'obs-soportes', source: 'obs', target: 'soportes', type: 'secondary' } },
        { data: { id: 'nodejs-frameworks', source: 'nodejs', target: 'frameworks', type: 'secondary' } },
        { data: { id: 'react-frameworks', source: 'react', target: 'frameworks', type: 'secondary' } },
        { data: { id: 'vue-frameworks', source: 'vue', target: 'frameworks', type: 'secondary' } },
        { data: { id: 'angular-frameworks', source: 'angular', target: 'frameworks', type: 'secondary' } },
